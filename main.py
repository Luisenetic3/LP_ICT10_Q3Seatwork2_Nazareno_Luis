...
def nanamigreen(event):
    ...
    if answer1 and answer3:
        ...
        if registration_choice == "yes" and clearance_choice == "yes1":
            ...
            images_data = {
                "LOGOS/BB.jpg": "Congratulations! You are part of Blue Bears!",
                "LOGOS/RB.jpg": "Congratulations! You are part of Red Buldogs!",
                "LOGOS/YT.jpg": "Congratulations! You are part of Yellow Tigers!",
                "LOGOS/GH.jpg": "Congratulations! You are part of Green Hornets!"
            }
